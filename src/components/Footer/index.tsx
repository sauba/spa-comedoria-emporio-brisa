  ...
  return (
    ...
    >
      <div className={`absolute z-40 left-0 right-0`}>
        <Image className={`cursor-none mx-auto opacity-90`} src={`/logo.svg`} width={360} height={360} alt="Comedoria Empório da Brisa" priority />
      ...
      <p className="relative font-bad-script text-center text-zinc-800 -top-6 z-40">© 2024 Todos os direitos reservados.</p>
    </footer>
  )
}